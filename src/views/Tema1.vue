  ...
  data: () => ({
    ...
    datosLineaTiempoC: [
      ...
      },
      {
        ...
        texto:
          'Jeans de tiro bajo, minifaldas, short, zuecos o sandalias, estampados animal print, fast fashion, pantalón pitillo, escote en V, supraciclaje, pantalón tiro alto, blusas campesinas.',
